...
def ISP_TPS(File_Path, p_array_1, e1_array, ev_array_1, parametr_isp, parametr_proba, press, parametr_d, parametr_press, vert_speed, random_start_e1, otn_def, picture_time):
